function SelectValue(id) {
    switch (id) {
        case 'ProblemSolving':
            return ["Unsatisfactory. Doesn't generate solutions to problems. Has insufficient problem-solving skills.",
        ...
        case 'ProfessionalismAndTeamwork':
            return ["Unsatisfactory.Does not follow through  on commitments. Has consistently failed to achieve goals as team member.",
        ...
        case 'Attendance':
            return ["Unsatisfactory. Breaks are long and too frequent. Has failed to call in sick ___ times",
        ...
        case 'ResourceUse':
            return ["Unsatisfactory. Has damaged resources needs by others.Received complaints about hoarding resources.",
        ...
        case 'AttitudeorApproachtoWork':
            return ["Unsatisfactory. Always find fault in others. Presence often creates tension in groups.",
        ...
        case'QualityofWork':
            return ["Unsatisfactory.On multiple occassions, errors have caused work stoppage or rework.Quality is not a priority.",
        ...
        case 'VerbalSkills':
            return ["Unsatisfactory. Does not build audience participation when needed. Often misunderstands what others are saying.",
        ...
        case 'EthicalBehavior':
            return ["Unsatisfactory. Does not behave ethically. Actions have resulted in customers refusing to do business with us.",
        ...
        case 'FeedbackReceivingAndGiving':
            return ["Unsatisfactory. Consistently takes feedback with negativity and disagreement. Consistently receives feedback denfensively and argumentatively.",
        ...
        case 'GroomingAndAppearance':
            return ["Unsatisfactory. Ignored requests to deal with appearance. Will often underdress for important meetings.",
        ...
        case 'Productivity':
            return ["Unsatisfactory. Production rate and quality are consistently low.One of the lowest producers in the department",
        ...
        case 'WrittenSkills':
            return ["Unsatisfactory. Numerous errors and lack of organization make understanding difficult. Poor writer.",
        ...
        case 'AbilityToMeetDeadlines':
            return ["Unsatisfactory.Often misses the standard deadlines. Does not admit to being behind schedule.",
        ...
        case 'TechnicalMonitoringofJobSkills':
            return ["Unsatisfactory. Not learning new skills.Doesn't pull resources together effectively.",
        ...
        case 'PersonalGrowth':
            return ["Unsatisfactory. Denies existence of personal difficulties. Works suffers because of inability to balance work, family and outside interest.",
        ...
        case 'ProductKnowledge':
            return ["Unsatisfactory. Presents incorrect product information to customer. Lacks critical product knowledge.",
        ...
        case 'ListeningSkills':
            return ["Unsatisfactory. Constantly interrupts. Not aware when he/she does not understand.",
        ...
        case 'AbilityToOrganizeAndDetailWorkProcesses':
            return ["Unsatisfactory. Spends too much time and energy working on issues that lack substance.",
        ...
        case 'AskingAppropriateQuestions':
            return ["Unsatisfactory. Does not know how to ask questions that will guide work.",
        ...
        case 'PotentialforAdvancement':
            return ["Unsatisfactory. Cannot cope with complex decision making. Has not generated the confidence of others required for promotion.",
